/*
 * protocols.c - Tell the hosts cache and display detailed IP protocols usage as viewed on network interface(s)
 *
 * -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
 *                    _        _
 *              _ __ | | _____| |__
...
#define OPTSTRING "hi:nurlfpPdDx"
  ...
  while ((option = getopt_long (argc, argv, OPTSTRING, long_options, NULL)) != -1)
	...
	case 128:
	  headargv = argsadd (headargv, "--label=Total IP[9]");
	  rowargv = argsadd (rowargv, "--ip-bytes-all");
	  break;

	case 129:
	  headargv = argsadd (headargv, "--label=HTTP[9]");
	  rowargv = argsadd (rowargv, "--http-bytes-all");
	  break;

	case 130:
	  headargv = argsadd (headargv, "--label=FTP[9]");
	  rowargv = argsadd (rowargv, "--ftp-bytes-all");
	  break;

	case 131:
	  headargv = argsadd (headargv, "--label=DNS[9]");
	  rowargv = argsadd (rowargv, "--dns-bytes-all");
	  break;

	case 132:
	  headargv = argsadd (headargv, "--label=Mail[9]");
	  rowargv = argsadd (rowargv, "--mail-bytes-all");
	  break;

	case 133:
	  headargv = argsadd (headargv, "--label=SSH[9]");
	  rowargv = argsadd (rowargv, "--ssh-bytes-all");
	  break;

	case 134:
	  headargv = argsadd (headargv, "--label=Telnet[9]");
	  rowargv = argsadd (rowargv, "--telnet-bytes-all");
	  break;

	case 135:
	  headargv = argsadd (headargv, "--label=X11[9]");
	  rowargv = argsadd (rowargv, "--x11-bytes-all");
	  break;

	case 136:
	  headargv = argsadd (headargv, "--label=NFS[9]");
	  rowargv = argsadd (rowargv, "--nfs-bytes-all");
	  break;

	case 137:
	  headargv = argsadd (headargv, "--label=DHCP/BOOTP[9]");
	  rowargv = argsadd (rowargv, "--dhcp-bytes-all");
	  break;

	case 138:
	  headargv = argsadd (headargv, "--label=SNMP[9]");
	  rowargv = argsadd (rowargv, "--snmp-bytes-all");
	  break;

	case 139:
	  headargv = argsadd (headargv, "--label=NNTP[9]");
	  rowargv = argsadd (rowargv, "--nntp-bytes-all");
	  break;

	case 140:
	  headargv = argsadd (headargv, "--label=NetBiosIP[9]");
	  rowargv = argsadd (rowargv, "--netbios-ip-bytes-all");
	  break;

	case 141:
	  headargv = argsadd (headargv, "--label=Kazaa[9]");
	  rowargv = argsadd (rowargv, "--kazaa-bytes-all");
	  break;

	case 142:
	  headargv = argsadd (headargv, "--label=Gnutella[9]");
	  rowargv = argsadd (rowargv, "--gnutella-bytes-all");
	  break;

	case 143:
	  headargv = argsadd (headargv, "--label=WinMX[9]");
	  rowargv = argsadd (rowargv, "--winmx-bytes-all");
	  break;

	case 144:
	  headargv = argsadd (headargv, "--label=DirectConn[9]");
	  rowargv = argsadd (rowargv, "--direct-connect-bytes-all");
	  break;

	case 145:
	  headargv = argsadd (headargv, "--label=eDonkey[9]");
	  rowargv = argsadd (rowargv, "--edonkey-bytes-all");
	  break;

	case 146:
	  headargv = argsadd (headargv, "--label=Messenger[9]");
	  rowargv = argsadd (rowargv, "--messenger-bytes-all");
	  break;

	case 147:
	  headargv = argsadd (headargv, "--label=Other[9]");
